...
public class KafkaConsumerConfiguration {
    ...
    public Map<String, Object> consumerConfig() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "ru.veselov.taskservice.dto.TaskResultDto");
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "ru.veselov.taskservice.dto");
        log.debug("Configuring consumer properties");
        return props;
    }

    @Bean
    public ConsumerFactory<String, TaskResultDto> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfig());
    }

    @Bean
    public KafkaListenerContainerFactory<
            ConcurrentMessageListenerContainer<String, TaskResultDto>> listenerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, TaskResultDto> factory =
