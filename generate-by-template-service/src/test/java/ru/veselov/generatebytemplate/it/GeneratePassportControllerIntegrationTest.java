...
import ru.veselov.generatebytemplate.it.config.KafkaConsumerTestConfiguration;
import ru.veselov.generatebytemplate.it.config.KafkaTestConsumer;
import ru.veselov.generatebytemplate.it.config.WebClientTestConfiguration;
